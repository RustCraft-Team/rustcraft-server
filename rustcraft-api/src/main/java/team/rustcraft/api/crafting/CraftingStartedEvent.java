...
/** Synchronously published when a crafting job starts. */
public record CraftingStartedEvent(CraftingJob job, CraftingRecipe recipe) implements Event {
    public CraftingStartedEvent {
